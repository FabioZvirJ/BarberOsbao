...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Barber&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.rating, rating) || other.rating == rating)&&const DeepCollectionEquality().equals(other.specialties, specialties)&&(identical(other.bio, bio) || other.bio == bio)&&const DeepCollectionEquality().equals(other.availableDays, availableDays)&&const DeepCollectionEquality().equals(other.availableHours, availableHours));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,avatarUrl,rating,const DeepCollectionEquality().hash(specialties),bio,const DeepCollectionEquality().hash(availableDays),const DeepCollectionEquality().hash(availableHours));

@override
String toString() {
  return 'Barber(id: $id, name: $name, avatarUrl: $avatarUrl, rating: $rating, specialties: $specialties, bio: $bio, availableDays: $availableDays, availableHours: $availableHours)';
}
...
@useResult
$Res call({
 String id, String name, String avatarUrl, double rating, List<String> specialties, String bio, List<String> availableDays, List<String> availableHours
});
...
/// Create a copy of Barber
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? avatarUrl = null,Object? rating = null,Object? specialties = null,Object? bio = null,Object? availableDays = null,Object? availableHours = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String avatarUrl,  double rating,  List<String> specialties,  String bio,  List<String> availableDays,  List<String> availableHours)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Barber() when $default != null:
return $default(_that.id,_that.name,_that.avatarUrl,_that.rating,_that.specialties,_that.bio,_that.availableDays,_that.availableHours);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String avatarUrl,  double rating,  List<String> specialties,  String bio,  List<String> availableDays,  List<String> availableHours)  $default,) {final _that = this;
switch (_that) {
case _Barber():
return $default(_that.id,_that.name,_that.avatarUrl,_that.rating,_that.specialties,_that.bio,_that.availableDays,_that.availableHours);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String avatarUrl,  double rating,  List<String> specialties,  String bio,  List<String> availableDays,  List<String> availableHours)?  $default,) {final _that = this;
switch (_that) {
case _Barber() when $default != null:
return $default(_that.id,_that.name,_that.avatarUrl,_that.rating,_that.specialties,_that.bio,_that.availableDays,_that.availableHours);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Barber&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.rating, rating) || other.rating == rating)&&const DeepCollectionEquality().equals(other._specialties, _specialties)&&(identical(other.bio, bio) || other.bio == bio)&&const DeepCollectionEquality().equals(other._availableDays, _availableDays)&&const DeepCollectionEquality().equals(other._availableHours, _availableHours));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,avatarUrl,rating,const DeepCollectionEquality().hash(_specialties),bio,const DeepCollectionEquality().hash(_availableDays),const DeepCollectionEquality().hash(_availableHours));
...
/// Create a copy of Barber
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? avatarUrl = null,Object? rating = null,Object? specialties = null,Object? bio = null,Object? availableDays = null,Object? availableHours = null,}) {
